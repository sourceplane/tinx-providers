...
import (
	...
	"github.com/sourceplane/tinx-providers/providers/setup-helm/internal/provider"
)
...
func main() {
	...
	fs.StringVar(&config.ToolName, "tool-name", firstNonEmpty(os.Getenv("TINX_TARGET_TOOL_NAME"), "helm"), "tool name to materialize")
