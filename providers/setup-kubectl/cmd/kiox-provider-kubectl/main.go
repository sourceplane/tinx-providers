...
func main() {
	...
	fs.StringVar(&config.ToolName, "tool-name", firstNonEmpty(os.Getenv("KIOX_TARGET_TOOL_NAME"), "kubectl"), "tool name to materialize")
	fs.BoolVar(&config.Debug, "debug", truthy(os.Getenv("KIOX_PROVIDER_DEBUG")), "enable debug logging")
